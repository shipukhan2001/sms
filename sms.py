...
""")
  ...
  sys.exit()
baner= os.system("logo=\033[38;5;46m")
baner = str(baner)
...
if usr== "1" or usr== "01":
  ...
  os.system("xdg-open https://www.facebook.com/profile.php?id=https://www.facebook.com/profile.php?id=61555583623727")
  sys.exit()
else:
